    ...
    <div className="flex h-screen bg-white">
      ...
      <aside className="w-64 bg-gray-100 p-4 border-r border-gray-300">
        ...
        <nav className="space-y-2">
          ...
          <h3 className="mt-6 text-sm text-gray-500">¿Que desea conocer de {}?</h3>
          <ul className="space-y-1">
            <li>
              <button onClick={() => navigate('./pages/tradiHuamantla')} className="text-left p-2 w-full hover:bg-gray-200 rounded ">
                Tradiciones
              </button>
            </li>
            <li>
